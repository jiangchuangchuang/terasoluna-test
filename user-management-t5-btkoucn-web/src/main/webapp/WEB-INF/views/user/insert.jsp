	...
	<div class="centerDiv" style="margin-top: 5%;">
		<form:form action="${pageContext.request.contextPath}/user/insert"
			...
			<div class="inputBoxDiv">
				...
				<form:input path="userId" cssErrorClass="inputStyle input-error" cssClass="inputStyle" value=""/>				
			...
			<div class="inputBoxDiv">
				...
				<form:input path="username" cssErrorClass="inputStyle input-error" cssClass="inputStyle" value=""/>				
			...
			<div class="inputBoxDiv">
				...
				<form:input path="birthDay" cssErrorClass="inputStyle input-error" cssClass="inputStyle" value=""/>
			...
			<div class="inputBoxDiv">
				...
				<form:input path="address" cssErrorClass="inputStyle input-error" cssClass="inputStyle" value=""/>				
			...
			<div class="inputBoxDiv">
				...
				<form:input path="tenNum" cssErrorClass="inputStyle input-error" cssClass="inputStyle" value=""/>				
			...
			<!-- 登録 -->
			<div class="inputBoxDiv">
				<form:button style="margin-left: 125px;" name="confirm"><spring:message code="userForm.button.insert"/></form:button>
			</div>
		</form:form>
	</div>
</div>